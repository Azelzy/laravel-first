<x-admin.layout>
    ...
    <div class="mb-4">
        <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Classroom</h2>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6">
        <form action="/admin/classrooms/{{ $classroom->id }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text" id="name" name="name" value="{{ old('name', $classroom->name) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" required>
                @error('name')
